...
public class MiscoOrderApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		DefaultMQPushConsumer consuper = new DefaultMQPushConsumer("producer_group_cluster11");
		// 设置注册中心
		consuper.setNamesrvAddr("192.168.2.168:9876;192.168.2.119:9876;192.168.2.148:9876;192.168.2.123:9876");
		// 设置默认接受信息为32条
		...
		consuper.subscribe("Topic_demo_cluster_1111", "*");
...
//		// 因为消费组也是一个集群 所以需要配置一个组名
//		DefaultMQPushConsumer consuper = new DefaultMQPushConsumer("producer_group_ccc");
//		// 设置注册中心
//		consuper.setNamesrvAddr("192.168.2.168:9876;192.168.2.119:9876;192.168.2.148:9876;192.168.2.123:9876");
//		// 设置默认接受信息为32条
//		consuper.setConsumeMessageBatchMaxSize(2);// 设置最大能接受2条
...
//		// top 对应生产者定义的主题 ，subExpression:对应生产端的producer tags ，* 带包所有 ，如上面的producer
//		// “Tags” ， 多个对的化使用 Tags || TagsA || TagsB
//		consuper.subscribe("Topic_demo_cu_1111", "*");
//		// 有序消费
